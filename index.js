...
export default class tmgFootballApp extends Component {
  state = { loggedIn: null };
        ...
        return (
          <StyleProvider style={getTheme(OffkeyTheme)}>
            <Container>
              <Router>
                <Scene key="root">
                  <Scene key="players" component={Players} title="Players" hideNavBar={true}/>
                  <Scene key="playerPage" component={PlayerPage} title="PlayerPage" hideNavBar={true}/>
...
AppRegistry.registerComponent('tmgFootballApp', () => tmgFootballApp);
